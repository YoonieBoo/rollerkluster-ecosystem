  ...
  return [
    {
      ...
      link: 'https://example.com/yoonie-au-campus-welcome',
      contentUrl: 'https://example.com/yoonie-au-campus-welcome',
    ...
    },
    {
      ...
      link: 'https://example.com/yoonie-campus-transition',
      contentUrl: 'https://example.com/yoonie-campus-transition',
    ...
    },
    {
      ...
      link: 'https://example.com/yoonie-study-carousel',
      contentUrl: 'https://example.com/yoonie-study-carousel',
    ...
    },
    {
      ...
      link: 'https://example.com/yoonie-sustainable-campus',
      contentUrl: 'https://example.com/yoonie-sustainable-campus',
    ...
    },
    {
      ...
      link: 'https://example.com/yoonie-day-recap',
      contentUrl: 'https://example.com/yoonie-day-recap',
    ...
    },
    {
      ...
      link: 'https://example.com/yoonie-wellness-routine',
      contentUrl: 'https://example.com/yoonie-wellness-routine',
    ...
    },
    {
      ...
      link: 'https://example.com/yoonie-campus-reflection',
      contentUrl: 'https://example.com/yoonie-campus-reflection',
    ...
    },
    {
      ...
      link: 'https://example.com/yoonie-story-set',
      contentUrl: 'https://example.com/yoonie-story-set',
